...
class RT_Banner extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Banner', 'gymat-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'id'      => 'banner_big_title',
				'label_block' => true,
				'label'   => esc_html__( 'Heading Title', 'gymat-core' ),
				'default' => esc_html__( 'GYM FITNESS', 'gymat-core' ),
			...
			array(
				...
				'label'   => esc_html__( 'Heading Title Color', 'gymat-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-banner-addon.style1 .gym-text-shape .heading-big-title' => '-webkit-text-stroke-color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::DIMENSIONS,
