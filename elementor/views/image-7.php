...
<div class="image-default image-<?php echo esc_attr( $data['style'] );?> ">
    <div class="image-box motion-effects-wrap">
        <div class="rt-about-layout">
            <div class="item-shape wow fadeInLeft rt-animate" data-wow-delay="1.2s" data-wow-duration="1.5s"><img width="445" height="622" src="<?php echo esc_url( GYMAT_ASSETS_URL . 'element/about-14.svg' ); ?>" alt="shape"></div>
            <div class="img-inner">
                <div class="item-img wow fadeInUp rt-animate" data-wow-delay="1.2s" data-wow-duration="1.5s">
                    ...
                    <div class="item-rt-shape">
                        <ul>
                            ...
                            <li class="motion-effects1"><img width="84" height="76" src="<?php echo esc_url( GYMAT_ASSETS_URL . 'element/shape-116.png' ); ?>" alt="shape" ></li>
                        </ul>
                    </div>
                </div>
            </div>
