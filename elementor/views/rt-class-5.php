...
$weeknames = array(
    'mon' => esc_html__( 'Mon', 'gymat-core' ),
    'tue' => esc_html__( 'Tue', 'gymat-core' ),
    'wed' => esc_html__( 'Wed', 'gymat-core' ),
    'thu' => esc_html__( 'Thur', 'gymat-core' ),
    'fri' => esc_html__( 'Fri', 'gymat-core' ),
    'sat' => esc_html__( 'Sat', 'gymat-core' ),
    'sun' => esc_html__( 'Sun', 'gymat-core' ),
);
$args = array(
