 ...
 *
 * @package RT\GYMATCORE\DemoImporter
 */
...
if ( ! defined( 'RT_GYMATCORE_DEMO_IMPORTER_PATH' ) ) {
    define( 'RT_GYMATCORE_DEMO_IMPORTER_PATH', __DIR__ );
}

if ( ! defined( 'RT_GYMATCORE_DEMO_IMPORTER_URL' ) ) {
    define( 'RT_GYMATCORE_DEMO_IMPORTER_URL', plugin_dir_url( __FILE__ ) );
}
...
spl_autoload_register(
    function ( $class ) {
        $namespaces = [
            'RT\\GYMATCORE\\DemoImporter\\' => __DIR__ . '/src/',
        ];
...
$demo_config = array_merge(
    [
        ...
        'core_base_dir'    => GYMAT_CORE_BASE_URL,
        'demo_content_dir' => RT_GYMATCORE_DEMO_IMPORTER_PATH,
        'demo_content_url' => RT_GYMATCORE_DEMO_IMPORTER_URL,
    ],
    $demo_config
);
...
try {
    new RT\GYMATCORE\DemoImporter\Core( $demo_config );
} catch ( Exception $e ) {
