...
namespace RT\GYMATCORE\DemoImporter;

use RT\GYMATCORE\DemoImporter\Utils;
use RT\GYMATCORE\DemoImporter\Handlers\WooHandler;
...
class Core {
    ...
    public function radius_booking() {
        ...
        $json_file_path = GYMAT_CORE_DEMO_CONTENT . 'demo-files/radius-booking.json';
